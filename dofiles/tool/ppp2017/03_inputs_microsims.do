...
foreach file of local files { // Open loop files
		...
		* Working age population
		...
		local pea = `r(sum_w)'
		post `mypost' ("`country'") (`year') ("Working age population") (`pea')
...
export excel using "$path_mpo/$input_master", sheet("input-labor-microsimulated") sheetreplace firstrow(variables)
if $mpo_share {
	export excel using "$path_share/$input_master", sheet("input-labor-microsimulated") sheetreplace firstrow(variables)
}
