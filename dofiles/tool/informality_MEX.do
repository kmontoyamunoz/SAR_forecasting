...
use "${rootdatalib}\SEDLAC\MEX\MEX_${year}_${survey}\MEX_${year}_${survey}_v${master}_M\Data\Stata\noagro" , clear
...
replace d_informal = (informalsubor==1 | selfemployed==1) & (voluntary==0) if sample == 1
