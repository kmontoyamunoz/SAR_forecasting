...
* Last update: Feb 23, 2024 Kelly Y. Montoya
*===========================================================================
...
if $sector_model == 3 {
	...
	* do-file 10 for re-scaling options
	if "$re_scale" == "yes" gl do_income "10_income_rel"
	else gl do_income "10_income_rel_no_rescaling"
...
* sectors (by default 6 sectors with informality)
gl m = num_sectors[1]
* new weights
...
* non-labor incomes
import excel using "$inputs", sheet("input_nonlabor (2)") first clear
