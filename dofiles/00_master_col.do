...
gl country COL 			// Country to upload
gl year 2022			// Year to upload - Base year dataset
gl final_year 2025		// Change for last simulated year
...
* 10.income growth by sector
	run "$thedo\10_income_rel_new_no_rescaling_col.do" 
* 11. total labor incomes
	run "$thedo/11_total_income.do"	
* 12. total non-labor incomes
	else run "$thedo\12_assign_nlai.do"
* 13. household income
