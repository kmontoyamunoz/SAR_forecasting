...
forvalues i = 1/`lim' {
   ...
   sum salaried  [w = pondera] if sectorg == `i' & sample_`k' == 1
   sca ns_`k'_`i' = 1-r(mean)
   
   sum public_job    [w = pondera] if sectorg == `i' & sample_`k' == 1
...
if $m != 1 {
	...
	forvalues n = 1/2 {
		...
		* Those who come from INACTIVITY
		mat score predila_n  = b_1_`n'  if occupation == 0 & occupation_s == 2 & sample_`n' == 1, replace
		mat score predila_n  = b_1_`n'  if occupation == 0 & occupation_s == 3 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 0 & occupation_s == 4 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 0 & occupation_s == 5 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 0 & occupation_s == 6 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 0 & occupation_s == 7 & sample_`n' == 1, replace

		* Those who come from UNEMPLOYMENT
		mat score predila_n  = b_1_`n'  if occupation == 1 & occupation_s == 2 & sample_`n' == 1, replace
		mat score predila_n  = b_1_`n'  if occupation == 1 & occupation_s == 3 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 1 & occupation_s == 4 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 1 & occupation_s == 5 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 1 & occupation_s == 6 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 1 & occupation_s == 7 & sample_`n' == 1, replace

		* Those who come from FORMAL - AGRICULTURE
		mat score predila_n  = b_1_`n'  if occupation == 2 & occupation_s == 3 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 2 & occupation_s == 4 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 2 & occupation_s == 5 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 2 & occupation_s == 6 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 2 & occupation_s == 7 & sample_`n' == 1, replace

	* Those who come from INFORMAL - AGRICULTURE
	   mat score predila_n  = b_1_`n'  if occupation == 3 & occupation_s == 2 & sample_`n' == 1, replace
	   mat score predila_n  = b_2_`n'  if occupation == 3 & occupation_s == 4 & sample_`n' == 1, replace
	   mat score predila_n  = b_2_`n'  if occupation == 3 & occupation_s == 5 & sample_`n' == 1, replace
	   mat score predila_n  = b_3_`n'  if occupation == 3 & occupation_s == 6 & sample_`n' == 1, replace
	   mat score predila_n  = b_3_`n'  if occupation == 3 & occupation_s == 7 & sample_`n' == 1, replace
	 
		* Those who come from FORMAL - INDUSTRY
		mat score predila_n  = b_1_`n'  if occupation == 4 & occupation_s == 2 & sample_`n' == 1, replace
		mat score predila_n  = b_1_`n'  if occupation == 4 & occupation_s == 3 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 4 & occupation_s == 5 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 4 & occupation_s == 6 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 4 & occupation_s == 7 & sample_`n' == 1, replace

		* Those who come from INFORMAL - INDUSTRY
		mat score predila_n  = b_1_`n'  if occupation == 5 & occupation_s == 2 & sample_`n' == 1, replace
		mat score predila_n  = b_1_`n'  if occupation == 5 & occupation_s == 3 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 5 & occupation_s == 4 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 5 & occupation_s == 6 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 5 & occupation_s == 7 & sample_`n' == 1, replace

		* Those who come from FORMAL - SERVICES
		mat score predila_n  = b_1_`n'  if occupation == 6 & occupation_s == 2 & sample_`n' == 1, replace
		mat score predila_n  = b_1_`n'  if occupation == 6 & occupation_s == 3 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 6 & occupation_s == 4 & sample_`n' == 1, replace
		mat score predila_n  = b_2_`n'  if occupation == 6 & occupation_s == 5 & sample_`n' == 1, replace
		mat score predila_n  = b_3_`n'  if occupation == 6 & occupation_s == 7 & sample_`n' == 1, replace

	* Those who come from INFORMAL - SERVICES
	   mat score predila_n  = b_1_`n'  if occupation == 7 & occupation_s == 2 & sample_`n' == 1, replace
	   mat score predila_n  = b_1_`n'  if occupation == 7 & occupation_s == 3 & sample_`n' == 1, replace
	   mat score predila_n  = b_2_`n'  if occupation == 7 & occupation_s == 4 & sample_`n' == 1, replace
	   mat score predila_n  = b_2_`n'  if occupation == 7 & occupation_s == 5 & sample_`n' == 1, replace
	   mat score predila_n  = b_3_`n'  if occupation == 7 & occupation_s == 6 & sample_`n' == 1, replace
