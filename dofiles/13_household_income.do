...
* Counterfactual
*egen     h_lai_s = sum(lai_s) , by(id)
egen     h_lai_s = sum(tot_lai_s) if jefe != ., by(id) m // KM: I corrected this.
...
* Total
egen     h_inc_s = rowtotal(h_inc h_lai_obs h_lai_s h_nlai_obs h_nlai_s) if jefe != ., missing 
